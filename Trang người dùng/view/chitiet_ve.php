                    ...
                    echo '
                       <div class="ticket">
                        <div class="ticket-position">
                            <div class="ticket__indecator indecator--pre"><div class="indecator-text pre--text">VM Cinema</div> </div>
                            <div class="ticket__inner">
                                <div class="ticket-secondary">
                                    ...
                                    <span class="ticket__item">Rạp : <span class="ticket__cinema">VM Cinema</span></span>
...
<span class="ticket__item ticket__item--primery ticket__film" style="display:flex;> <strong class="ticket__movie" >PHIM : ' . $tieu_de . '</strong></span>                                    <span class="ticket__item ticket__item--primery">Ghế: <span class="ticket__place">' . $ghe . '</span></span>
                            ...
                            <div class="ticket__indecator indecator--post"><div class="indecator-text post--text">VM Cinema</div></div>
                        </div>
                        <div>
