...
function gui_mail_ve($load_ve_tt) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'vuducmanh2002hb@gmail.com';
        $mail->Password   = 'ckdi xfyz kvkl xjtb';
        $mail->SMTPSecure = PHPMailer\PHPMailer\PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = 587;

        // Email người gửi
        $mail->setFrom('vuducmanh2002hb@gmail.com', 'VM Cinema');
        ...
        $mail->Body    = 'Xác nhận Đặt Vé Xem Phim Thành Công <br><hr>
                            ...
                            Chúng tôi xin chân thành cảm ơn bạn đã chọn VM Cinema để trải nghiệm bộ phim tuyệt vời. Chúc mừng! Đơn đặt vé của bạn đã được xác nhận thành công. 
