...
<div class="content-body">
    ...
    <div class="row">
        ...
        <div class="col-xlg-6 col-md-6 col-12 mb-30">
            <div class="top-report">
                ...
                <div class="head">
                    ...
                    <a href="index.php?act=DTdh&&trang=1" class="view"><i class="zmdi zmdi-eye"></i></a>
                </div>
        ...
        <div class="col-xlg-6 col-md-6 col-12 mb-30">
            <div class="top-report">
                ...
                <div class="head">
                    ...
                    <a href="index.php?act=ve" class="view"><i class="zmdi zmdi-eye"></i></a>
                </div>
        ...
        <div class="col-xlg-6 col-md-6 col-12 mb-30">
            <div class="top-report">
                ...
                <div class="head">
                    ...
                    <a href="index.php?act=DTngay&&trang=1" class="view"><i class="zmdi zmdi-eye"></i></a>
                </div>
        ...
        <div class="col-xlg-6 col-md-6 col-12 mb-30">
            <div class="top-report">
                ...
                <div class="head">
                    ...
                    <a href="index.php?act=DTtuan&&trang=1" class="view"><i class="zmdi zmdi-eye"></i></a>
                </div>
        ...
        <div class="col-xlg-6 col-md-6 col-12 mb-30">
            <div class="top-report">
                ...
                <div class="head">
                    ...
                    <a href="index.php?act=DTthang&&trang=1" class="view"><i class="zmdi zmdi-eye"></i></a>
                </div>
        ...
        <div class="col-xlg-6 col-md-6 col-12 mb-30">
            <div class="top-report">
                ...
                <div class="head">
                    ...
                    <a href="index.php?act=QLphim" class="view"><i class="zmdi zmdi-eye"></i></a>
                </div>
        ...
        <?php }else{
            echo '<h1>Chào mừng '.$_SESSION['user1']['name'].' đến với trang làm việc của VM Cinema</h1>';
        } ?>
